...
const projects = [
  {
    ...
    description: "A modern e-commerce solution with streamlined checkout process and inventory management.",
    tags: ["Next.js", "TypeScript", "Stripe", "Tailwind CSS"],
    url: "https://threetwentyonegh.com",
    features: [
      { icon: <Monitor className="w-4 h-4" />, text: "Responsive design across all devices" },
      { icon: <Package className="w-4 h-4" />, text: "Integrated inventory management" },
      { icon: <Layers className="w-4 h-4" />, text: "Secure payment processing" },
    ],
  ...
  // },
  {
    ...
    description: "A platform where users can exchange their skills for currency.",
    tags: ["React", "Node.js", "Express", "MongoDB"],
    url: "https://skillexchange.vercel.app",
    features: [
      { icon: <Monitor className="w-4 h-4" />, text: "User-friendly skill marketplace" },
      { icon: <Package className="w-4 h-4" />, text: "Secure transaction system" },
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-900 text-black dark:text-white font-light antialiased selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black">
      <header className="fixed top-0 w-full z-50 bg-white/80 dark:bg-neutral-900/80 backdrop-blur-sm border-b border-neutral-100 dark:border-neutral-800">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="flex h-16 items-center justify-between">
            <Link href="#home" className="text-xl font-light tracking-tighter transition-opacity hover:opacity-80">
              PORTFOLIO
            </Link>
                ...
                {navItems.map((item) => (
                  <Link
                    ...
                    className={cn(
                      ...
                      activeSection === item.href.substring(1) ? "font-medium" : "font-light",
                    )}
                  >
                    {item.name}
                  </Link>
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="container h-full px-4 flex flex-col">
              <div className="flex h-16 items-center justify-between">
                <Link href="#home" className="text-xl font-light tracking-tighter">
                  PORTFOLIO
                </Link>
                <Button
                  variant="outline"
      ...
      <main className="pt-16">
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                <p className="text-neutral-700 dark:text-neutral-300 md:text-lg max-w-xl mx-auto">
                  Crafting digital experiences with clean code and minimal aesthetics. Based in Accra, working globally.
                </p>
        ...
        <Section id="about" className="py-20 md:py-32 bg-neutral-50 dark:bg-neutral-800">
          <div className="container px-4 md:px-6 mx-auto">
                ...
                <div className="relative">
                  ...
                  <div className="pl-6 pt-6">
                    ...
                    <div className="space-y-4 text-lg leading-relaxed">
                      <p>
                        I&#39;m a passionate frontend developer with over 5 years of experience creating elegant and
                        functional web applications. My approach combines clean code architecture with intuitive user
                        interfaces, resulting in memorable digital experiences.
                      </p>
                      <p>
                        Having worked with startups and established companies alike, I bring a versatile skill set and
                        adaptable mindset to every project. I&#39;m particularly drawn to minimal design that emphasizes
                        content and functionality, believing that simplicity often leads to the most powerful user
                        experiences.
                      </p>
                      <p>When I&#39;m not coding, you&#39;ll find me watching anime or playing video games.</p>
                    </div>
        ...
        <Section id="stack" className="py-20 md:py-32 bg-neutral-50 dark:bg-neutral-800">
          <div className="container px-4 md:px-6 mx-auto">
            <SectionHeading>Tech Stack</SectionHeading>

            <div className="max-w-4xl mx-auto">
              <p className="text-lg text-center mb-12 text-neutral-700 dark:text-neutral-300">
                I work with a variety of modern technologies to build robust and performant applications. My core
                expertise lies in JavaScript frameworks with a focus on React and its ecosystem.
              </p>
              ...
              <div className="grid gap-12 md:grid-cols-2 items-center">
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-neutral-700 dark:text-neutral-300 mb-8">
                      I&#39;m currently available for freelance work and exciting collaborations. If you have a project that
                      needs creative attention, feel free to reach out.
                    </p>
                ...
                >
                  <div className="bg-neutral-50 dark:bg-neutral-800 p-8 rounded-xl border border-neutral-200 dark:border-neutral-700">
                    <h4 className="text-xl font-light mb-6">Send me a message</h4>
      ...
      <footer className="py-8 bg-neutral-900 dark:bg-black text-neutral-400">
        <div className="container px-4 md:px-6 mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <Link href="#home" className="text-xl font-light tracking-tighter text-white mb-4 block">
                PORTFOLIO
              </Link>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {navItems.map((item) => (
                  <Link key={item.name} href={item.href} className="text-sm transition-colors hover:text-white">
                    {item.name}
                  </Link>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="mailto:alvinyeboah5@gmail.com" className="text-sm block transition-colors hover:text-white">
                  alvinyeboah5@gmail.com
                </a>
  ...
  return (
    ...
    >
      <div className="p-4 border border-transparent group-hover:border-neutral-200 dark:group-hover:border-neutral-700 rounded-lg transition-all">
        ...
        <p className="text-sm text-neutral-600 dark:text-neutral-400">{approach.description}</p>
      </div>
    </motion.div>
  )
}
...
function ExperienceCard({ experience, index }: { experience: any; index: number }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="text-sm text-neutral-500 dark:text-neutral-400 mb-1">{experience.period}</div>
      <div className="transition-all duration-300">
        <h4 className="font-medium">{experience.title}</h4>
        <p className="text-sm text-neutral-700 dark:text-neutral-300 mb-1">{experience.company}</p>
        <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-2">{experience.description}</p>
  ...
  return (
    ...
    >
      <motion.div
        ...
        whileHover={{ scale: 1.5 }}
      />
      <div className="text-sm text-neutral-500 dark:text-neutral-400 mb-1">{education.period}</div>
      <div className="transition-all duration-300">
        <h4 className="font-medium">{education.degree}</h4>
        <p className="text-sm text-neutral-700 dark:text-neutral-300 mb-1">{education.institution}</p>
        <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-2">{education.description}</p>
          ...
          >
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="space-y-2">
                {project.features.map((feature: any, featureIndex: number) => (
                  ...
                  >
                    <div className="mr-2 text-black dark:text-white">{feature.icon}</div>
                    {feature.text}
                  </motion.div>
                ))}
              </div>
            ...
            <div className="mt-6">
              <Link href={project.url} target="_blank" rel="noopener noreferrer">
                <Button variant="link" className="group p-0 h-auto font-normal text-black dark:text-white">
                  View Project
...
function InteractiveMockup({
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-full h-full ${mockup.type === "browser" ? "pt-8" : mockup.type === "mobile" ? "pt-6" : ""} flex flex-col`}
      >
          ...
          if (element.type === "grid") {
            return (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
              >
                <div className={`w-full h-full grid grid-cols-${element.columns} gap-4`}>
                  {Array.from({ length: element.columns }).map((_, i) => (
                    <div key={i} className="bg-white dark:bg-neutral-800 rounded-lg" />
                  ))}
                </div>
              </motion.div>
            )
          ...
          if (element.type === "split") {
            return (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
              >
                <div className={`w-[${element.ratio * 100}%] h-full bg-white dark:bg-neutral-800 p-4`}>
                  <div className="w-full h-full flex flex-col space-y-3">
                ...
                <div className={`w-[${(1 - element.ratio) * 100}%] h-full flex items-center justify-center`}>
