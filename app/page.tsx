...
const projects = [
  {
    ...
    url: "https://threetewntyonegh.com",
  },
  {
    title: "Health & Fitness App",
    description:
      "Personalized workout tracking and nutrition management application with progress analytics.",
...
const experiences = [
  {
    ...
    description:
      "Developed and maintained dynamic, responsive web applications using Next.js and React.js. Implemented modern styling frameworks like Tailwind CSS to create scalable and reusable design components. Collaborated with back-end developers to integrate APIs and optimize front-end performance. Contributed to the design and implementation of mobile-first interfaces, ensuring compatibility across various devices and browsers. Worked closely with the design team to translate Figma prototypes into pixel-perfect, functional web pages.",
  },
  {
    period: "2023 - Present",
    ...
    description:
      "Worked solo on both front-end and back-end development to deliver high-quality, CMS-driven web solutions, ensuring seamless user experiences and efficient workflows. Implemented and managed payment integrations, enabling secure and reliable transactions across multiple platforms. Developed and maintained core functionalities, ensuring smooth API connections and data flow.",
  },
];
        ...
        >
          <div className="container px-4 md:px-6 mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              ...
              >
                <div className="w-24 h-24 mx-auto border border-neutral-200 dark:border-neutral-700 rounded-full flex items-center justify-center">
                  <span className="text-3xl font-light">AY</span>
                </div>
              </motion.div>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    {experiences.map((exp, index) => (
                      <TimelineItem key={index} date={exp.period} index={index}>
  ...
  return (
    ...
    >
      <div className="p-4 border border-transparent group-hover:border-neutral-200 dark:group-hover:border-neutral-700 rounded-lg transition-all">
        <div className="text-3xl font-light mb-2 text-neutral-400 group-hover:text-black dark:group-hover:text-white transition-colors">
          {approach.number}
        </div>
  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-12 gap-8 items-center">
        <div className="md:col-span-7 relative overflow-hidden rounded-lg border border-neutral-200 dark:border-neutral-700">
...
function NodeIcon() {
  return (
    <svg
      ...
      className="w-6 h-6 fill-current"
    >
      <path d="M224 508c-6.7 0-13.5-1.8-19.4-5.2l-61.7-36.5c-9.2-5.2-4.7-7-1.7-8 12.3-4.3 14.8-5.2 27.9-12.7 1.4-.8 3.2-.5 4.6.4l47.4 28.1c1.7 1 4.1 1 5.7 0l184.7-106.6c1.7-1 2.8-3 2.8-5V149.3c0-2.1-1.1-4-2.9-5.1L226.8 37.7c-1.7-1-4-1-5.7 0L36.6 144.3c-1.8 1-2.9 3-2.9 5.1v213.1c0 2 1.1 4 2.9 4.9l50.6 29.2c27.5 13.7 44.3-2.4 44.3-18.7V167.5c0-3 2.4-5.3 5.4-5.3h23.4c2.9 0 5.4 2.3 5.4 5.3V378c0 36.6-20 57.6-54.7 57.6-10.7 0-19.1 0-42.5-11.6l-48.4-27.9C8.1 389.2.7 376.3.7 362.4V149.3c0-13.8 7.4-26.8 19.4-33.7L204.6 9c11.7-6.6 27.2-6.6 38.8 0l184.7 106.7c12 6.9 19.4 19.8 19.4 33.7v213.1c0 13.8-7.4 26.7-19.4 33.7L243.4 502.8c-5.9 3.4-12.6 5.2-19.4 5.2zm149.1-210.1c0-39.9-27-50.5-83.7-58-57.4-7.6-63.2-11.5-63.2-24.9 0-11.1 4.9-25.9 47.4-25.9 37.9 0 51.9 8.2 57.7 33.8.5 2.4 2.7 4.2 5.2 4.2h24c1.5 0 2.9-.6 3.9-1.7s1.5-2.6 1.4-4.1c-3.7-44.1-33-64.6-92.2-64.6-52.7 0-84.1 22.2-84.1 59.5 0 40.4 31.3 51.6 56.6 60.5 60.5 65.2 14.8 65.2 26.7 0 20.6-16.6 29.4-55.5 29.4-48.9 0-59.6-12.3-63.2-36.6-.4-2.6-2.6-4.5-5.3-4.5h-23.9c-3 0-5.3 2.4-5.3 5.3 0 31.1 16.9 68.2 97.8 68.2 58.4-.1 92-23.2 92-63.4z" />
    </svg>
  );
}
...
function NextJsIcon() {
  return (
    <svg
      ...
      className="w-6 h-6 fill-current"
    >
      <path d="M11.572 0c-.176 0-.31.001-.358.007a19.76 19.76 0 0 1-.364.033C7.443.346 4.25 2.185 2.228 5.012a11.875 11.875 0 0 0-2.119 5.243c-.096.659-.108.854-.108 1.747s.012 1.089.108 1.748c.652 4.506 3.86 8.292 8.209 9.695.779.25 1.6.422 2.534.525.363.04 1.935.04 2.299 0 1.611-.178 2.977-.577 4.323-1.264.207-.106.247-.134.219-.158-.02-.013-.9-1.193-1.955-2.9-2.62l-1.919-2.592-2.404-3.558a338.739 338.739 0 0 0-2.422-3.556c-.009-.002-.018 1.579-.023 3.51-.007 3.38-.01 3.515-.052 3.595a.426.426 0 0 1-.206.214c-.075.037-.14.044-.495.044H7.81l-.108-.068a.438.438 0 0 1-.157-.171l-.05-.106.006-4.703.007-4.705.072-.092a.645.645 0 0 1 .174-.143c.096-.047.134-.051.5-.051.478 0 .558.018.682.154.035.038 1.337 1.999 2.895 4.361a10760.433 10760.433 0 0 0 4.735 7.17l1.9 2.879.096-.063a12.317 12.317 0 0 0 2.466-2.163 11.944 11.944 0 0 0 2.824-6.134c.096-.66.108-.854.108-1.748 0-.893-.012-1.088-.108-1.747-.652-4.506-3.859-8.292-8.208-9.695a12.597 12.597 0 0 0-2.499-.523A33.119 33.119 0 0 0 11.573 0zm4.069 7.217c.347 0 .408.005.486.047a.473.473 0 0 1 .237.277c.018.06.023 1.365.018 4.304l-.006 4.218-.744-1.14-.746-1.14v-3.066c0-1.982.01-3.097.023-3.15a.478.478 0 0 1 .233-.296c.096-.05.13-.054.5-.054z" />
    </svg>
  );
}
